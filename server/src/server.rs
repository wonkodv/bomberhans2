...
impl Server {
    ...
    pub fn handle_client_packet(&mut self, packet: ClientPacket, client_address: SocketAddr) -> Option<ServerPacket> {
        ...
        match &packet.message {
            ...
            | ClientMessage::LobbySettingsUpdate(ClientLobbySettingsUpdate { client_id, .. })
        ...
        let message = match packet.message {
            ...
            ClientMessage::OpenNewLobby(client_id) => {
                ...
                client.game = Some(ClientGame { game_id, player_id, last_acknowledge_time: TimeStamp::new() });
